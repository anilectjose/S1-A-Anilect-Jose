...
void insert1(); void insert2(); void insert3(); void traversebeg(); void search();
...
i++; }
create();
temp->prev = temp2; temp->next = temp2->next; temp2->next->prev = temp; temp2->next = temp;
} }
void delete() {
int i = 1, pos;
